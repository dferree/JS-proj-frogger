document.addEventListener('DOMContentLoaded', () => {
   ...
   const obs2 = document.querySelector('.l1', '.l2', '.l3');
   const backg2 = document.querySelector('.l4' , '.l5');

     // choose second obstacle
     function changeObstacle2() {
       const obstacle2Radio = document.querySelector('input[name="obstacle2"]:checked');
       if (obstacle2Radio) {
         const obstacle2Id = obstacle2Radio.value;
         if (obstacle2Id === 'log') {
           const obs2 = document.querySelectorAll('.l1, .l2, .l3');
           const backg2 = document.querySelectorAll('.l4, .l5');
           obs2.forEach((element) => {
             element.style.backgroundImage = 'url(/media/log.png)';
           });
           backg2.forEach((element) => {
             element.style.backgroundImage = 'url(/media/river.png)';
           });
         }
       }
     }
  ...
  function changeCharacter() {
    ...
    if (characterRadio) {
      ...
      if (characterId === 'froggie') {
        ...
        frogImage.src = '/media/frog-classic-2.png';
  ...
  function moveFrog(e) {
    if(frogImage){
      frogImage = document.querySelector('.frog-image');
      frogElement.removeChild(frogImage);
